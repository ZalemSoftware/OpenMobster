 ...
 */
@ServiceInfo(uri="/status/mobilebeanservice")
public class StatusMobileBeanService implements MobileServiceBean
{
	private static Logger log = Logger.getLogger(StatusMobileBeanService.class);
	
	public StatusMobileBeanService()
	{
