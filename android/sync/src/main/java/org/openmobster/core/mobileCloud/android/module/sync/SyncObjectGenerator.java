...
{	
	...
	{
		return (SyncObjectGenerator)Registry.getActiveInstance().
		lookup(SyncObjectGenerator.class);
	}
	...
	public Session parse(String xml) throws SyncException
	{
		...
		{
			throw new SyncException(this.getClass().getName(), "parse", new Object[]{xml});
		}
		finally
		{
			if(is != null)
