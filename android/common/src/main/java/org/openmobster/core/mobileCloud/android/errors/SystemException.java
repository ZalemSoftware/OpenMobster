...
public final class SystemException extends RuntimeException
{
	 ...
	 * 
	 */
	protected String className = null; //non-null
	
	/**
	 * 
	 */
	protected String method = null; //non-null
	
	/**
	 * 
	 */
	protected Object[] parameters = null; //nullable
	 ...
	 * @param parameters
	 */
	public SystemException(String className, String method, Object[] parameters)
	{
		super();
