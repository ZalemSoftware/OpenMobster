...
public final class DBException extends BaseException 
{
	 ...
	 * @param parameters
	 */
	public DBException(String className, String methodName, Object[] parameters)
	{
		super(className, methodName, parameters);
	}
	
	public DBException(String className, String methodName, Object[] parameters, int errorCode)
	{
