 ...
 */
@ServiceInfo(uri="ping")
public class PingMobileBeanService implements MobileServiceBean
{
	private static Logger log = Logger.getLogger(PingMobileBeanService.class);
	
	public PingMobileBeanService()
	{
